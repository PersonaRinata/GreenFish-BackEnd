...
type Publisher interface {
	Publish(ctx context.Context, req *sociality.QingyuRelationActionRequest) error
}
...
func (s *SocialityServiceImpl) Action(ctx context.Context, req *sociality.QingyuRelationActionRequest) (resp *sociality.QingyuRelationActionResponse, err error) {
	resp = new(sociality.QingyuRelationActionResponse)
...
func (s *SocialityServiceImpl) GetRelationIdList(ctx context.Context, req *sociality.QingyuGetRelationIdListRequest) (resp *sociality.QingyuGetRelationIdListResponse, err error) {
	resp = new(sociality.QingyuGetRelationIdListResponse)
...
func (s *SocialityServiceImpl) GetSocialInfo(ctx context.Context, req *sociality.QingyuGetSocialInfoRequest) (resp *sociality.QingyuGetSocialInfoResponse, err error) {
	resp = new(sociality.QingyuGetSocialInfoResponse)
...
func (s *SocialityServiceImpl) BatchGetSocialInfo(ctx context.Context, req *sociality.QingyuBatchGetSocialInfoRequest) (resp *sociality.QingyuBatchGetSocialInfoResponse, err error) {
	resp = new(sociality.QingyuBatchGetSocialInfoResponse)
