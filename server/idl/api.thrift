...
service ApiService {
    douyin_user_register_response Register(1: douyin_user_register_request req)(api.post="/qingyu/user/register/");
    douyin_user_login_response Login(1: douyin_user_login_request req)(api.post="/qingyu/user/login/");
    douyin_user_response GetUserInfo(1: douyin_user_request req)(api.get="/qingyu/user/");

    douyin_feed_response Feed (1: douyin_feed_request req)(api.get="/qingyu/feed/");
    douyin_publish_action_response PublishVideo (1: douyin_publish_action_request req)(api.post="/qingyu/publish/action/");
    douyin_publish_list_response VideoList (1: douyin_publish_list_request req)(api.get="/qingyu/publish/list/");

    douyin_favorite_action_response Favorite(1: douyin_favorite_action_request req)(api.post="/qingyu/favorite/action/");
    douyin_favorite_list_response FavoriteList(1: douyin_favorite_list_request req)(api.get="/qingyu/favorite/list/");
    douyin_comment_action_response Comment(1: douyin_comment_action_request req)(api.post="/qingyu/comment/action/");
    douyin_comment_list_response CommentList(1: douyin_comment_list_request req)(api.get="/qingyu/comment/list/");

    douyin_relation_action_response Action(1: douyin_relation_action_request req)(api.post="/qingyu/relation/action/");
    douyin_relation_follow_list_response FollowingList(1: douyin_relation_follow_list_request req)(api.get="/qingyu/relation/follow/list/");
    douyin_relation_follower_list_response FollowerList(1: douyin_relation_follower_list_request req)(api.get="/qingyu/relation/follower/list/");
    douyin_relation_friend_list_response FriendList(1: douyin_relation_friend_list_request req)(api.get="/qingyu/relation/friend/list/");

    douyin_message_chat_response ChatHistory(1: douyin_message_chat_request req)(api.get="/qingyu/message/chat/");
    douyin_message_action_response SentMessage(1: douyin_message_action_request req)(api.post="/qingyu/message/action/");
}