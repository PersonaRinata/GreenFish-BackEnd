...
type User struct {
	...
	Nickname        string `thrift:"nickname,13" frugal:"13,default,string" json:"nickname"`
}
...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field13DeepEqual(ano.Nickname) {
		return false
	}
	return true
}
...
type FriendUser struct {
	...
	Time            int64  `thrift:"time,13" frugal:"13,default,i64" json:"time"`
	MsgType         int64  `thrift:"msgType,14" frugal:"14,default,i64" json:"msgType"`
	Nickname        string `thrift:"nickname,15" frugal:"15,default,string" json:"nickname"`
}
...
func (p *FriendUser) SetTime(val int64) {
	p.Time = val
}
func (p *FriendUser) SetMsgType(val int64) {
	p.MsgType = val
}
func (p *FriendUser) SetNickname(val string) {
	p.Nickname = val
}
...
func (p *FriendUser) DeepEqual(ano *FriendUser) bool {
	...
	if !p.Field13DeepEqual(ano.Time) {
		return false
	}
	if !p.Field14DeepEqual(ano.MsgType) {
		return false
	}
	if !p.Field15DeepEqual(ano.Nickname) {
		return false
	}
	return true
}
...
func (p *FriendUser) Field14DeepEqual(src int64) bool {
...
func (p *FriendUser) Field15DeepEqual(src string) bool {
...
func (p *LatestMsg) SetTime(val int64) {
	p.Time = val
}
...
func (p *LatestMsg) Field3DeepEqual(src int64) bool {
...
func (p *DiseaseRelation) InitDefault() {
	*p = DiseaseRelation{}
}

func (p *DiseaseRelation) GetDiseaseIntroduction() (v string) {
	return p.DiseaseIntroduction
}

func (p *DiseaseRelation) GetFamilyDiseases() (v string) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DiseaseRelation[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *DiseaseRelation) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
...
func (p *DiseaseRelation) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.FamilyDiseases = v
...
func (p *DiseaseRelation) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DiseaseRelation"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *DiseaseRelation) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DiseaseRelation(%+v)", *p)
}

func (p *DiseaseRelation) DeepEqual(ano *DiseaseRelation) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.DiseaseIntroduction) {
		return false
	}
	if !p.Field2DeepEqual(ano.FamilyDiseases) {
		return false
	}
	if !p.Field3DeepEqual(ano.HistoryDiseases) {
		return false
	}
	return true
}

func (p *DiseaseRelation) Field1DeepEqual(src string) bool {

	if strings.Compare(p.DiseaseIntroduction, src) != 0 {
		return false
	}
	return true
}
func (p *DiseaseRelation) Field2DeepEqual(src string) bool {

	if strings.Compare(p.FamilyDiseases, src) != 0 {
		return false
	}
	return true
}
...
func (p *HistoryDiseases) InitDefault() {
	*p = HistoryDiseases{}
}

func (p *HistoryDiseases) GetSymptom() (v string) {
	return p.Symptom
}

func (p *HistoryDiseases) GetMedicines() (v []string) {
	return p.Medicines
}

func (p *HistoryDiseases) GetDepartment() (v string) {
	return p.Department
}

func (p *HistoryDiseases) GetUpdateTime() (v int64) {
	return p.UpdateTime
}
func (p *HistoryDiseases) SetSymptom(val string) {
	p.Symptom = val
}
func (p *HistoryDiseases) SetMedicines(val []string) {
	p.Medicines = val
}
func (p *HistoryDiseases) SetDepartment(val string) {
	p.Department = val
}
func (p *HistoryDiseases) SetUpdateTime(val int64) {
	p.UpdateTime = val
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HistoryDiseases[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HistoryDiseases) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Symptom = v
...
func (p *HistoryDiseases) ReadField2(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *HistoryDiseases) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Department = v
...
func (p *HistoryDiseases) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.UpdateTime = v
...
func (p *HistoryDiseases) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("HistoryDiseases"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *HistoryDiseases) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("HistoryDiseases(%+v)", *p)
}

func (p *HistoryDiseases) DeepEqual(ano *HistoryDiseases) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field2DeepEqual(ano.Medicines) {
		return false
	}
	if !p.Field3DeepEqual(ano.Department) {
		return false
	}
...
func (p *HistoryDiseases) Field1DeepEqual(src string) bool {
...
func (p *HistoryDiseases) Field2DeepEqual(src []string) bool {

	if len(p.Medicines) != len(src) {
		return false
	}
	for i, v := range p.Medicines {
		_src := src[i]
...
func (p *HistoryDiseases) Field3DeepEqual(src string) bool {
...
func (p *HistoryDiseases) Field4DeepEqual(src int64) bool {
...
func (p *BodyInfo) GetBloodSugar() (v string) {
	return p.BloodSugar
}
...
func (p *BodyInfo) SetBloodSugar(val string) {
	p.BloodSugar = val
}
...
func (p *BodyInfo) DeepEqual(ano *BodyInfo) bool {
	...
	if !p.Field5DeepEqual(ano.BloodSugar) {
		return false
	}
...
func (p *BodyInfo) Field5DeepEqual(src string) bool {

	if strings.Compare(p.BloodSugar, src) != 0 {
		return false
	}
	return true
}
...
var IssueList_DiseaseRelation_DEFAULT *DiseaseRelation

func (p *IssueList) GetDiseaseRelation() (v *DiseaseRelation) {
	if !p.IsSetDiseaseRelation() {
		return IssueList_DiseaseRelation_DEFAULT
	}
	return p.DiseaseRelation
}
...
func (p *IssueList) SetDiseaseRelation(val *DiseaseRelation) {
	p.DiseaseRelation = val
}
