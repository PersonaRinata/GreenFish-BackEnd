...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"SearchVideoList":         kitex.NewMethodInfo(searchVideoListHandler, newVideoServiceSearchVideoListArgs, newVideoServiceSearchVideoListResult, false),
	}
...
func searchVideoListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*video.VideoServiceSearchVideoListArgs)
	realResult := result.(*video.VideoServiceSearchVideoListResult)
	success, err := handler.(video.VideoService).SearchVideoList(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceSearchVideoListArgs() interface{} {
	return video.NewVideoServiceSearchVideoListArgs()
}

func newVideoServiceSearchVideoListResult() interface{} {
	return video.NewVideoServiceSearchVideoListResult()
}
...
func (p *kClient) SearchVideoList(ctx context.Context, req *video.QingyuSearchVideoRequest) (r *video.QingyuSearchVideoResponse, err error) {
	var _args video.VideoServiceSearchVideoListArgs
	_args.Req = req
	var _result video.VideoServiceSearchVideoListResult
	if err = p.c.Call(ctx, "SearchVideoList", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
